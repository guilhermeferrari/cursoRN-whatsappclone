import { MODIFICA_ADICIONA_CONTATO_EMAIL, ADICIONA_CONTATO_ERRO, ADICIONA_CONTATO_SUCESSO, VOLTAR_CENA_ADDCONTATO, ABRIR_PAG_ADDCONTATO, LISTA_CONTATO_USUARIO, MODIFICA_MENSAGEM } from "./types";
...
export const enviarMensagem = (mensagem, contatoNome, contatoEmail) => {
    ...
    return dispatch => {
        ...
        firebase.database().ref(`/mensagens/${usuarioEmailB64}`)
            .push({ mensagem, tipo: 'e' })
            .then(() => {
                firebase.database().ref(`/mensagens/${contatoEmailB64}`)
